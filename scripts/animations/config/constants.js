export const MORPH_POINTS_CHECK_ICON = [
...
export const MESSAGES = {
  BASE_ELEMENT_REQUIRED: 'BaseElement не определен',
  INSTANCEOF_BASE_ANIMATION:
    'Элемент должен наследоваться от класса SectionAnimation',
  ANIMATION_IS_RUNNING: 'Анимация уже запущена',
  EFFECT_INSTANCEOF:
    'Эффект должен наследоваться от класса BaseEffect',
}
