...
9. Скрипт подключается на страницу только 1 - название-страницы.js. Все остальное импортируется в него
...
- Комментарии в разметке и стилях оставляем обязательно с тегами:
  - fix: блок нуждающийся в корректировке
  - QnA: вопрос\предложение\улучшение
  - **Пример: fix: исправить font-weight**
